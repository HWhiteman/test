...
setwd("C:/Users/havok/Documents/School/Practical Data Science - Berkeley/Webinar Code")
    ...
    sidebarLayout(
      sidebarPanel(
        selectInput(inputID = "subset_income", label = "Select Income",
                  choices = "unique"<=50K","50K", multiple=FALSE),
  ...
  output$myfigure <- 
    ...
    renderPlot(ggplot(
      ...
      create_subset()) +
        ...
        geom_boxplot(
          #13________
        aes_string(x="occupation", y= input$set_yaxis))) +
                                  theme_bw(18) +
